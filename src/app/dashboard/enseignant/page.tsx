                      ...
                      <div className="p-6 md:p-10 space-y-6 md:space-y-8">
                        <div className="flex items-start justify-between">
                          <div className="space-y-1">
                            ...
                            {isMainTeacher && mainTeacherClass === cls && (
                              <Badge className="bg-amber-500 text-white border-none font-black text-[7px] md:text-[9px] uppercase px-2 py-0.5 mt-1.5">
                                <Award className="size-2.5 mr-1" /> Professeur Principal
                              </Badge>
                            )}
                          </div>
