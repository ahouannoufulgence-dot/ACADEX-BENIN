  ...
  const handleLogin = async (e: React.FormEvent) => {
    ...
    setTimeout(() => {
      ...
      toast({
        ...
        description: "Bienvenue sur ACADEX, Dr. Koffi Mensah.",
      });
    ...
    <div className="min-h-screen flex items-center justify-center bg-[#F8FAFC] p-6 relative overflow-hidden">
      ...
      <div className="w-full max-w-md animate-in fade-in zoom-in-95 duration-500">
        <div className="flex flex-col items-center mb-10">
          ...
          <h1 className="text-3xl font-black text-foreground tracking-tight">ACADEX <span className="text-primary">SECURE</span></h1>
        ...
        <Card className="border-none shadow-2xl rounded-[2.5rem] bg-white overflow-hidden">
          ...
          <CardHeader className="space-y-1 pt-8 px-10">
            ...
            <CardDescription className="font-medium">Entrez vos identifiants pour accéder au cockpit.</CardDescription>
          </CardHeader>
          <CardContent className="px-10 pb-8">
            <form onSubmit={handleLogin} className="space-y-6">
              ...
              <div className="space-y-2">
                ...
                <div className="relative">
                  <Input 
                    ...
                    className="h-12 rounded-xl bg-muted/30 border-none font-bold focus-visible:ring-primary pr-10"
                    required 
                  />
                </div>
              </div>
              ...
              <Button 
                type="submit" 
                className="w-full h-14 bg-primary hover:bg-primary/90 rounded-2xl font-black text-lg shadow-xl shadow-primary/20 gap-3"
          ...
          <CardFooter className="bg-muted/30 p-6 flex flex-col gap-2">
            <p className="text-[10px] text-muted-foreground font-black uppercase text-center tracking-widest">
              Système d'Audit ACADEX Actif
            </p>
            <Link href="/" className="text-xs text-center font-bold text-primary hover:underline">
              Retour à l'accueil
            </Link>
          </CardFooter>
        </Card>
        ...
        <p className="mt-8 text-center text-xs text-muted-foreground font-medium">
          &copy; 2024 ACADEX - Plateforme de confiance pour l'excellence au Bénin.
        </p>
      </div>
    </div>
  );
